...
vr::IVRSystem* initOpenVR(uint32_t& hmdWidth, uint32_t& hmdHeight) {
	...
	//vr::IVRCompositor SetTrackingSpace(TrackingUniverseOrigin::TrackingUniverseSeated);
	compositor->SetTrackingSpace(vr::TrackingUniverseOrigin::TrackingUniverseSeated);
